...
window.I18N = {
  zh: {
    ...
    form_title: "发送询盘",
    form_sub: "填写以下信息，选择邮箱或 WhatsApp 联系，我们会尽快回复您。",
    form_name: "您的姓名 *",
    form_email: "邮箱",
    ...
    form_btn_email: "邮箱联系",
    form_btn_wa: "WhatsApp 联系",
    form_fill: "请填写姓名与需求描述",
    form_ok: "已为您打开 WhatsApp，发送即可联系我们！",
    form_ok_email: "已发送成功！我们会尽快回复您。",
    form_sending: "发送中…",
    form_err: "发送失败，请稍后重试或直接邮件联系我们。",
    wa_none: "未填写",
    wa_guide_title: "已复制询盘内容，接下来这样联系我：",
    wa_guide_s1: "打开 WhatsApp",
    wa_guide_s2: "添加我的号码并粘贴发送",
    wa_guide_copy: "复制号码",
    wa_guide_copyall: "复制询盘内容",
    wa_guide_copied: "已复制 ✓",
    wa_guide_open: "打开 WhatsApp",
  ...
  en: {
    ...
    form_sub: "Fill in your details and contact us via email or WhatsApp.",
    form_name: "Your Name *",
    form_email: "Email",
    ...
    form_btn_email: "Email Us",
    form_btn_wa: "WhatsApp",
    form_fill: "Please fill in your name and requirements",
    form_ok: "WhatsApp opened — just send to reach us!",
    form_ok_email: "Sent! We'll get back to you soon.",
    form_sending: "Sending…",
    form_err: "Failed to send. Please try again or email us directly.",
    wa_none: "Not provided",
    wa_guide_title: "Inquiry copied. Now contact me like this:",
    wa_guide_s1: "Open WhatsApp",
    wa_guide_s2: "Add my number, paste & send",
    wa_guide_copy: "Copy number",
    wa_guide_copyall: "Copy inquiry",
    wa_guide_copied: "Copied ✓",
    wa_guide_open: "Open WhatsApp",
